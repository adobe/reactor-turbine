...
describe('function returned by createPublicRequire', function() {
  ...
  it('should return the dynamic core modules', function() {
    ...
    var getExtensionConfigurationMock = {};
    ...
    var publicRequire = createPublicRequire({
      ...
      getExtensionConfiguration: getExtensionConfigurationMock,
    ...
    expect(publicRequire('@turbine/get-extension-configuration'))
      .toBe(getExtensionConfigurationMock);
